...
Usage:
    python modules/mission_planning/tests/tools/test_div_area.py
...
MISSION_PLANNING_DIR = MODULES_DIR / "mission_planning"
TESTS_DIR = MISSION_PLANNING_DIR / "tests"
for path in (REPO_ROOT, MODULES_DIR, MISSION_PLANNING_DIR, TESTS_DIR):
