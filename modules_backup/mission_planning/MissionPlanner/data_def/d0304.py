...
try:
    from ..runtime_settings import get_runtime_altitude_layers_m as _get_runtime_altitude_layers_m
except Exception:
    try:
...
def _build_rl_route(
    ...
    *,
    ...
    bundle_root = Path(__file__).resolve().parents[1] / "portable_mission_bundle"
    ...
    # DEM 자동 선택
    resource_dir = Path(__file__).resolve().parents[4] / "resource"
