# modules/common/generator/message0402_generator.py
# auto-generated at 2025-08-24T14:56:18.144122+00:00
...
def _gen_ROIInfo(source: str = "DS"):
    obj = {}
...
def make_msg0402_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0402, RootType: ROIInfo"""
    ex = _gen_ROIInfo(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0402_push import make_and_push
