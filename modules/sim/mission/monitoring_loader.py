...
def _build_vehicles_from_0401(payload: dict[str, Any] | None) -> tuple[dict[str, Any], dict[str, int], int | None]:
    ...
    for state in agent_states:
        ...
        entry: dict[str, Any] = {
            ...
            "roll": float(_to_float(_pick_value(attitude, ("roll", "Roll"))) or 0.0),
            "pitch": float(_to_float(_pick_value(attitude, ("pitch", "Pitch"))) or 0.0),
            "yaw": float(_to_float(_pick_value(attitude, ("yaw", "Yaw"))) or 0.0),
