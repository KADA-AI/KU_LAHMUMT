# modules/common/receive/message0903_receiver.py
# auto-generated at 2025-08-24T16:37:13.121885+00:00

from dll_files.nFusionImports import *            # IFusionReceive, IsLocal, IsSingletone
from nFusion.Model.msg_0903 import *            # C# 모델
...
def _to_dict_RequestRenewMission(obj):
    d = {}
...
class RequestRenewMissionReceiver_0903(IFusionReceive[RequestRenewMission], IsLocal, IsSingletone):
    ...
    def Receive(self, data: RequestRenewMission, src):
        try:
            _try_save_received('0903', data)

            body = _try_read_db_body('0903', data)
            if body is None:
                body = _to_dict_RequestRenewMission(data)

            notify("0903", json.dumps(body, ensure_ascii=False).encode("utf-8","ignore"))
