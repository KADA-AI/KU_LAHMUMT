# modules/common/receive/message0204_receiver.py
# auto-generated at 2026-07-07T08:52:17.731505+00:00

from dll_files.nFusionImports import *            # IFusionReceive, IsLocal, IsSingletone
from nFusion.Model.msg_0204 import *            # C# 모델
...
TX_FIELD_WHITELIST = {'0201': ['timestamp', 'inputMissionPackageID'], '0204': ['timestamp', 'inputMissionPackageID'], '0203': ['timestamp', 'missionReferencePackageID'], '0301': ['timestamp', 'missionPlanID'], '0302': ['timestamp', 'individualMissionPackageID'], '0303': ['timestamp', 'pathID'], '0304': ['timestamp', 'pathID']}
DB_DIR_RULES        = {'0201': 'InputMissionPlan', '0204': 'InputMissionPlan', '0203': 'FlightReferenceInfo', '0301': 'MissionPlan', '0302': 'IndividualMissionPlan', '0303': 'UAVFlightPlan', '0304': 'FlightPath'}
DB_FETCH_ON_RECEIVE = {'0203', '0201'}
ID_FIELD_FOR        = {'0201': 'inputMissionPackageID', '0204': 'inputMissionPackageID', '0203': 'missionReferencePackageID', '0301': 'missionPlanID', '0302': 'individualMissionPackageID', '0303': 'pathID', '0304': 'pathID'}
...
def _to_dict_OutputMissionPlan(obj):
    d = {}
...
class OutputMissionPlanReceiver_0204(IFusionReceive[OutputMissionPlan], IsLocal, IsSingletone):
    """0204 OutputMissionPlan 메시지 수신 리시버"""
    __namespace__ = "OutputMissionPlanReceiver_0204"

    def Receive(self, data: OutputMissionPlan, src):
        try:
            _try_save_received('0204', data)

            body = _try_read_db_body('0204', data)
            if body is None:
                body = _to_dict_OutputMissionPlan(data)

            notify("0204", json.dumps(body, ensure_ascii=False).encode("utf-8","ignore"))

        except Exception:
            print("[ERROR][Receive-0204] traceback ↓↓↓")
