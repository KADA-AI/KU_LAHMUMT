# modules/common/receive/message0803_receiver.py
# auto-generated at 2025-08-24T16:37:13.114870+00:00

from dll_files.nFusionImports import *            # IFusionReceive, IsLocal, IsSingletone
from nFusion.Model.msg_0803 import *            # C# 모델
...
def _to_dict_ExecutionCommand(obj):
    d = {}
...
class ExecutionCommandReceiver_0803(IFusionReceive[ExecutionCommand], IsLocal, IsSingletone):
    """0803 ExecutionCommand 메시지 수신 리시버"""
    __namespace__ = "ExecutionCommandReceiver_0803"

    def Receive(self, data: ExecutionCommand, src):
        try:
            _try_save_received('0803', data)

            body = _try_read_db_body('0803', data)
            if body is None:
                body = _to_dict_ExecutionCommand(data)

            notify("0803", json.dumps(body, ensure_ascii=False).encode("utf-8","ignore"))
