# modules/common/receive/message0502_receiver.py
# auto-generated at 2025-08-24T16:37:13.101867+00:00

from dll_files.nFusionImports import *            # IFusionReceive, IsLocal, IsSingletone
from nFusion.Model.msg_0502 import *            # C# 모델
...
def _to_dict_EndMissionRequest(obj):
    d = {}
...
class EndMissionRequestReceiver_0502(IFusionReceive[EndMissionRequest], IsLocal, IsSingletone):
    """0502 EndMissionRequest 메시지 수신 리시버"""
    __namespace__ = "EndMissionRequestReceiver_0502"

    def Receive(self, data: EndMissionRequest, src):
        try:
            _try_save_received('0502', data)

            body = _try_read_db_body('0502', data)
            if body is None:
                body = _to_dict_EndMissionRequest(data)

            notify("0502", json.dumps(body, ensure_ascii=False).encode("utf-8","ignore"))
