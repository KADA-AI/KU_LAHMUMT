# modules/common/receive/message0202_receiver.py
# auto-generated at 2025-08-24T16:37:13.083601+00:00

from dll_files.nFusionImports import *            # IFusionReceive, IsLocal, IsSingletone
from nFusion.Model.msg_0202 import *            # C# 모델
...
def _to_dict_PriorMissionInfo(obj):
    d = {}
...
class PriorMissionInfoReceiver_0202(IFusionReceive[PriorMissionInfo], IsLocal, IsSingletone):
    """0202 PriorMissionInfo 메시지 수신 리시버"""
    __namespace__ = "PriorMissionInfoReceiver_0202"

    def Receive(self, data: PriorMissionInfo, src):
        try:
            _try_save_received('0202', data)

            body = _try_read_db_body('0202', data)
            if body is None:
                body = _to_dict_PriorMissionInfo(data)

            notify("0202", json.dumps(body, ensure_ascii=False).encode("utf-8","ignore"))
