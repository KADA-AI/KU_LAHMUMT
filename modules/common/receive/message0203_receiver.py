...
DB_DIR_RULES        = {'0201': 'InputMissionPlan', '0203': 'MissionReferenceInfo', '0301': 'MissionPlan', '0302': 'IndividualMissionPlan', '0303': 'UAVFlightPlan', '0304': 'FlightPath'}
...
def _to_dict_AltitudeLimits(obj):
    ...
    if _v is not None: d['lowerLimit'] = int(_v)
    _v = _get(obj, 'upperLimit', 'UpperLimit')
    if _v is not None: d['upperLimit'] = int(_v)
    return d
