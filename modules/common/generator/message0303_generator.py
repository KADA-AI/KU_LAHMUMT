# modules/common/generator/message0303_generator.py
# auto-generated at 2025-08-24T14:56:18.136121+00:00
...
def _gen_LoiterProperty(source: str = "DS"):
    obj = {}
    obj["radius"] = gen_value("radius", "int32", MSG_ID, obj, 0)
    obj["direction"] = gen_value("direction", "uint32", MSG_ID, obj, 0)
    obj["time"] = gen_value("time", "uint32", MSG_ID, obj, 0)
    obj["speed"] = gen_value("speed", "float32", MSG_ID, obj, 0)
    return obj
...
def _gen_FilmingProperty(source: str = "DS"):
    obj = {}
...
def _gen_Waypoint(source: str = "DS"):
    obj = {}
    obj["waypointID"] = gen_value("waypointID", "uint32", MSG_ID, obj, 0)
    obj["coordinate"] = _gen_Coordinate(source=source)
    obj["speed"] = gen_value("speed", "float32", MSG_ID, obj, 0)
    obj["eta"] = gen_value("eta", "uint32", MSG_ID, obj, 0)
    obj["ecf"] = gen_value("ecf", "float32", MSG_ID, obj, 0)
    obj["nextWaypointID"] = gen_value("nextWaypointID", "uint32", MSG_ID, obj, 0)
    obj["waypointPassType"] = gen_value("waypointPassType", "uint32", MSG_ID, obj, 0)
    obj["loiterProperty"] = _gen_LoiterProperty(source=source)
    obj["filmingProperty"] = _gen_FilmingProperty(source=source)
    return obj

def _gen_UAVFlightPlanData(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["pathID"] = gen_value("pathID", "uint32", MSG_ID, obj, 0)
    obj["aircraftID"] = gen_value("aircraftID", "uint32", MSG_ID, obj, 0)
    obj["isFormationFlight"] = gen_value("isFormationFlight", "bool", MSG_ID, obj, 0)
    obj["formationInfo"] = _gen_FormationInfo(source=source)
    obj["waypointList"] = [ _gen_Waypoint(source=source) for _ in range(LIST_LEN) ]
    return obj




def make_msg0303_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0303, RootType: UAVFlightPlanData"""
    ex = _gen_UAVFlightPlanData(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0303_push import make_and_push
