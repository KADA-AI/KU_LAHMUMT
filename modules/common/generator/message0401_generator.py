# modules/common/generator/message0401_generator.py
# auto-generated at 2025-08-24T14:56:18.142121+00:00
...
def _gen_Velocity(source: str = "DS"):
    obj = {}
    obj["speed"] = gen_value("speed", "float32", MSG_ID, obj, 0)
    obj["heading"] = gen_value("heading", "float32", MSG_ID, obj, 0)
    return obj

def _gen_Attitude(source: str = "DS"):
    return {
...
def _gen_Weapons(source: str = "DS"):
    obj = {}
    obj["type1"] = gen_value("type1", "uint32", MSG_ID, obj, 0)
    obj["type2"] = gen_value("type2", "uint32", MSG_ID, obj, 0)
    obj["type3"] = gen_value("type3", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_DatalinkStatus(source: str = "DS"):
    obj = {}
    obj["isConnectedToUAV1"] = gen_value("isConnectedToUAV1", "bool", MSG_ID, obj, 0)
    obj["isConnectedToUAV2"] = gen_value("isConnectedToUAV2", "bool", MSG_ID, obj, 0)
    obj["isConnectedToUAV3"] = gen_value("isConnectedToUAV3", "bool", MSG_ID, obj, 0)
    return obj

def _gen_MannedInfo(source: str = "DS"):
    obj = {}
    obj["weapons"] = _gen_Weapons(source=source)
    obj["datalinkStatus"] = _gen_DatalinkStatus(source=source)
    return obj

def _gen_CurrentWaypointID(source: str = "DS"):
    obj = {}
    obj["waypointID"] = gen_value("waypointID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_LoiterCoordinate(source: str = "DS"):
    obj = {}
    obj["latitude"] = gen_value("latitude", "float64", MSG_ID, obj, 0)
    obj["longitude"] = gen_value("longitude", "float64", MSG_ID, obj, 0)
    obj["altitude"] = gen_value("altitude", "int32", MSG_ID, obj, 0)
...
def _gen_TargetFollowing(source: str = "DS"):
    obj = {}
    obj["targetID"] = gen_value("targetID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_LeaderAircraftID(source: str = "DS"):
    obj = {}
    obj["aircraftID"] = gen_value("aircraftID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_CenterCoordinate(source: str = "DS"):
    obj = {}
    obj["latitude"] = gen_value("latitude", "float64", MSG_ID, obj, 0)
    obj["longitude"] = gen_value("longitude", "float64", MSG_ID, obj, 0)
    obj["altitude"] = gen_value("altitude", "int32", MSG_ID, obj, 0)
...
def _gen_SensorInfo(source: str = "DS"):
    obj = {}
...
def _gen_UnmannedInfo(source: str = "DS"):
    obj = {}
    ...
    obj["sensorInfo"] = _gen_SensorInfo(source=source)
    obj["payloadHealth"] = gen_value("payloadHealth", "uint32", MSG_ID, obj, 0)
    obj["fuelWarning"] = gen_value("fuelWarning", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_AgentState(source: str = "DS"):
    obj = {}
    obj["aircraftID"] = gen_value("aircraftID", "uint32", MSG_ID, obj, 0)
    obj["isUnmanned"] = gen_value("isUnmanned", "bool", MSG_ID, obj, 0)
    obj["coordinate"] = _gen_Coordinate(source=source)
    obj["velocity"] = _gen_Velocity(source=source)
    obj["attitude"] = _gen_Attitude(source=source)
...
def _gen_AgentStatus(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["source"] = gen_value("source", "string", MSG_ID, obj, 0)
    obj["agentStateList"] = [ _gen_AgentState(source=source) for _ in range(LIST_LEN) ]
    return obj




def make_msg0401_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0401, RootType: AgentStatus"""
    ex = _gen_AgentStatus(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0401_push import make_and_push
