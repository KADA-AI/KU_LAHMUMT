# modules/common/generator/message0601_generator.py
# auto-generated at 2025-08-24T14:56:18.152149+00:00
...
def _gen_BasicAction(source: str = "DS"):
    obj = {}
    ...
    obj["filmingMode"] = gen_value("filmingMode", "uint32", MSG_ID, obj, 0)
    return obj




def make_msg0601_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0601, RootType: BasicAction"""
    ex = _gen_BasicAction(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0601_push import make_and_push
