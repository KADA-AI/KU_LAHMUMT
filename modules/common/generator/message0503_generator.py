# modules/common/generator/message0503_generator.py
# auto-generated at 2025-08-24T14:56:18.150122+00:00
...
def _gen_MissionResult(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["source"] = gen_value("source", "string", MSG_ID, obj, 0)
    obj["systemRecommend"] = gen_value("systemRecommend", "uint32", MSG_ID, obj, 0)
    return obj




def make_msg0503_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0503, RootType: MissionResult"""
    ex = _gen_MissionResult(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0503_push import make_and_push
