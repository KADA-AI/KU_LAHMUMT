# modules/common/generator/message0802_generator.py
# auto-generated at 2025-08-24T14:56:18.162148+00:00
...
def _gen_MandatoryCommand(source: str = "DS"):
    obj = {}
    ...
    obj["mandatoryType"] = gen_value("mandatoryType", "uint32", MSG_ID, obj, 0)
    return obj




def make_msg0802_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0802, RootType: MandatoryCommand"""
    ex = _gen_MandatoryCommand(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0802_push import make_and_push
