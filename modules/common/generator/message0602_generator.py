# modules/common/generator/message0602_generator.py
# auto-generated at 2025-08-24T14:56:18.154148+00:00
...
def _gen_PathFollowing(source: str = "DS"):
    obj = {}
    obj["startWaypointID"] = gen_value("startWaypointID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_TargetTracking(source: str = "DS"):
    obj = {}
    obj["targetID"] = gen_value("targetID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_Coordinate(source: str = "DS"):
    obj = {}
    obj["latitude"] = gen_value("latitude", "float64", MSG_ID, obj, 0)
    obj["longitude"] = gen_value("longitude", "float64", MSG_ID, obj, 0)
    obj["altitude"] = gen_value("altitude", "int32", MSG_ID, obj, 0)
    return obj

def _gen_LoiterProperty(source: str = "DS"):
    obj = {}
    obj["coordinate"] = _gen_Coordinate(source=source)
    obj["loiterTime"] = gen_value("loiterTime", "float32", MSG_ID, obj, 0)
    obj["loiterRadius"] = gen_value("loiterRadius", "float32", MSG_ID, obj, 0)
    obj["loiterDirection"] = gen_value("loiterDirection", "uint32", MSG_ID, obj, 0)
    obj["loiterSpeed"] = gen_value("loiterSpeed", "float32", MSG_ID, obj, 0)
    return obj

def _gen_Formation(source: str = "DS"):
    obj = {}
    obj["dX"] = gen_value("dX", "int32", MSG_ID, obj, 0)
    obj["dY"] = gen_value("dY", "int32", MSG_ID, obj, 0)
    obj["dZ"] = gen_value("dZ", "int32", MSG_ID, obj, 0)
    return obj

def _gen_FormationInfo(source: str = "DS"):
    obj = {}
    obj["leaderAircraftID"] = gen_value("leaderAircraftID", "uint32", MSG_ID, obj, 0)
    obj["formation"] = _gen_Formation(source=source)
    return obj

def _gen_FlightModeCommand(source: str = "DS"):
    obj = {}
    obj["flightMode"] = gen_value("flightMode", "uint32", MSG_ID, obj, 0)
    obj["pathFollowing"] = _gen_PathFollowing(source=source)
    obj["targetTracking"] = _gen_TargetTracking(source=source)
    obj["loiterProperty"] = _gen_LoiterProperty(source=source)
    obj["formationInfo"] = _gen_FormationInfo(source=source)
    return obj

def _gen_CoordinateOrientation(source: str = "DS"):
    obj = {}
    obj["coordinate"] = _gen_Coordinate(source=source)
    return obj

def _gen_LineSearch(source: str = "DS"):
    obj = {}
    obj["coordinateList"] = [ _gen_Coordinate(source=source) for _ in range(LIST_LEN) ]
    obj["searchSpeed"] = gen_value("searchSpeed", "float32", MSG_ID, obj, 0)
    return obj

def _gen_AutoTracking(source: str = "DS"):
    obj = {}
    obj["targetID"] = gen_value("targetID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_AircraftFixed(source: str = "DS"):
    obj = {}
    obj["gimbalPitch"] = gen_value("gimbalPitch", "float32", MSG_ID, obj, 0)
    obj["gimbalYaw"] = gen_value("gimbalYaw", "float32", MSG_ID, obj, 0)
    return obj

def _gen_GimbalYawLimits(source: str = "DS"):
    obj = {}
    obj["leftLimit"] = gen_value("leftLimit", "float32", MSG_ID, obj, 0)
    obj["rightLimit"] = gen_value("rightLimit", "float32", MSG_ID, obj, 0)
    return obj

def _gen_AutoScan(source: str = "DS"):
    obj = {}
    obj["gimbalPitch"] = gen_value("gimbalPitch", "float32", MSG_ID, obj, 0)
    obj["gimbalYawLimits"] = _gen_GimbalYawLimits(source=source)
    obj["gimbalYawAngularSpeed"] = gen_value("gimbalYawAngularSpeed", "float32", MSG_ID, obj, 0)
    return obj

def _gen_FilmingModeCommand(source: str = "DS"):
    obj = {}
    obj["fieldOfView"] = gen_value("fieldOfView", "float32", MSG_ID, obj, 0)
    obj["sensorType"] = gen_value("sensorType", "uint32", MSG_ID, obj, 0)
    obj["operationMode"] = gen_value("operationMode", "uint32", MSG_ID, obj, 0)
    obj["coordinateOrientation"] = _gen_CoordinateOrientation(source=source)
    obj["lineSearch"] = _gen_LineSearch(source=source)
    obj["autoTracking"] = _gen_AutoTracking(source=source)
    obj["aircraftFixed"] = _gen_AircraftFixed(source=source)
    obj["autoScan"] = _gen_AutoScan(source=source)
    return obj

def _gen_UAVCommand(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["source"] = gen_value("source", "string", MSG_ID, obj, 0)
    obj["uavCommandModeType"] = gen_value("uavCommandModeType", "uint32", MSG_ID, obj, 0)
    obj["aircraftID"] = gen_value("aircraftID", "uint32", MSG_ID, obj, 0)
    obj["flightModeCommand"] = _gen_FlightModeCommand(source=source)
    obj["filmingModeCommand"] = _gen_FilmingModeCommand(source=source)
    return obj




def make_msg0602_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0602, RootType: UAVCommand"""
    ex = _gen_UAVCommand(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0602_push import make_and_push
    return make_and_push(make_msg0602_body(), node_messenger)
