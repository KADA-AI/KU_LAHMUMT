# modules/common/generator/message0902_generator.py
# auto-generated at 2025-08-24T14:56:18.171150+00:00
...
def _gen_ReplanRequestTime(source: str = "DS"):
    obj = {}
    obj["replanRequestTimestamp"] = gen_value("replanRequestTimestamp", "uint64", MSG_ID, obj, 0)
    return obj

def _gen_InputMissionID(source: str = "DS"):
    obj = {}
    obj["inputMissionID"] = gen_value("inputMissionID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_IndividualMissionID(source: str = "DS"):
    obj = {}
...
def _gen_TargetOrientation(source: str = "DS"):
    obj = {}
    obj["targetID"] = gen_value("targetID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_PriorMission(source: str = "DS"):
    obj = {}
    obj["priorMissionID"] = gen_value("priorMissionID", "uint32", MSG_ID, obj, 0)
    obj["missionType"] = gen_value("missionType", "uint32", MSG_ID, obj, 0)
    obj["coordinateOrientation"] = _gen_CoordinateOrientation(source=source)
    obj["targetOrientation"] = _gen_TargetOrientation(source=source)
    return obj

def _gen_PendingOption(source: str = "DS"):
    obj = {}
    obj["optionID"] = gen_value("optionID", "uint32", MSG_ID, obj, 0)
    obj["optionName"] = gen_value("optionName", "string", MSG_ID, obj, 0)
    obj["missionPlanID"] = gen_value("missionPlanID", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_ReplanRequest(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["source"] = gen_value("source", "string", MSG_ID, obj, 0)
    obj["replanRequestTime"] = _gen_ReplanRequestTime(source=source)
    obj["replanLevel"] = gen_value("replanLevel", "uint32", MSG_ID, obj, 0)
...
def make_msg0902_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0902, RootType: ReplanRequest"""
    ex = _gen_ReplanRequest(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0902_push import make_and_push
