# modules/common/generator/message0202_generator.py
# auto-generated at 2025-08-24T14:56:18.127615+00:00
...
def _gen_PriorMissionInfo(source: str = "DS"):
    obj = {}
...
def make_msg0202_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0202, RootType: PriorMissionInfo"""
    ex = _gen_PriorMissionInfo(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0202_push import make_and_push
