# modules/common/generator/message0502_generator.py
# auto-generated at 2025-08-24T14:56:18.148121+00:00
...
def _gen_EndMissionRequest(source: str = "DS"):
    obj = {}
...
def make_msg0502_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0502, RootType: EndMissionRequest"""
    ex = _gen_EndMissionRequest(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0502_push import make_and_push
