# modules/common/generator/message0304_generator.py
# auto-generated at 2025-08-24T14:56:18.138121+00:00
...
def _gen_Hovering(source: str = "DS"):
    obj = {}
    obj["time"] = gen_value("time", "uint64", MSG_ID, obj, 0)
    return obj

def _gen_Loiter(source: str = "DS"):
    obj = {}
...
def _gen_Attack(source: str = "DS"):
    obj = {}
    obj["targetID"] = gen_value("targetID", "uint32", MSG_ID, obj, 0)
    obj["weaponType"] = gen_value("weaponType", "uint32", MSG_ID, obj, 0)
    return obj

def _gen_LAHWaypoint(source: str = "DS"):
    obj = {}
    ...
    obj["hovering"] = _gen_Hovering(source=source)
    obj["loiter"] = _gen_Loiter(source=source)
    obj["attack"] = _gen_Attack(source=source)
    return obj

def _gen_LAHFlightPlanData(source: str = "DS"):
    obj = {}
    ...
    obj["lahWaypointList"] = [ _gen_LAHWaypoint(source=source) for _ in range(LIST_LEN) ]
    return obj




def make_msg0304_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0304, RootType: LAHFlightPlanData"""
    ex = _gen_LAHFlightPlanData(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0304_push import make_and_push
    return make_and_push(make_msg0304_body(), node_messenger)
