# modules/common/generator/message0305_generator.py
# auto-generated at 2025-08-24T14:56:18.140121+00:00
...
def _gen_ReplanStatus(source: str = "DS"):
    obj = {}
...
def make_msg0305_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0305, RootType: ReplanStatus"""
    ex = _gen_ReplanStatus(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0305_push import make_and_push
