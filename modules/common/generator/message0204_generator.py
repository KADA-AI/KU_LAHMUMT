# modules/common/generator/message0204_generator.py
# auto-generated at 2026-07-07T08:52:17.706992+00:00
...
def _gen_OutputMissionPlan(source: str = "DS"):
    obj = {}
...
def make_msg0204_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0204, RootType: OutputMissionPlan"""
    ex = _gen_OutputMissionPlan(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0204_push import make_and_push
    return make_and_push(make_msg0204_body(), node_messenger)

if __name__ == "__main__":
    print(json.dumps(make_msg0204_body(), ensure_ascii=False, indent=2))