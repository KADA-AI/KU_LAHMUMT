# modules/common/generator/message0805_generator.py
# auto-generated at 2025-08-24T14:56:18.165148+00:00
...
def _gen_SystemEvent(source: str = "DS"):
    obj = {}
...
def make_msg0805_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0805, RootType: SystemEvent"""
    ex = _gen_SystemEvent(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0805_push import make_and_push
    return make_and_push(make_msg0805_body(), node_messenger)
