# modules/common/generator/message0801_generator.py
# auto-generated at 2025-08-24T14:56:18.160148+00:00
...
def _gen_InitialPlanCommand(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["source"] = gen_value("source", "string", MSG_ID, obj, 0)
    obj["operatorReplanRequestTime"] = gen_value("operatorReplanRequestTime", "uint64", MSG_ID, obj, 0)
...
def make_msg0801_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0801, RootType: InitialPlanCommand"""
    ex = _gen_InitialPlanCommand(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0801_push import make_and_push
