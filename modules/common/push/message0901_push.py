# modules/common/push/message0901_push.py
# auto-generated at 2025-08-24T20:13:14.041862+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0901 import *    # C# 모델(우선)
...
def _dict_to_RequestOptionInfo(data: dict):
    obj = _new('RequestOptionInfo')
    ...
    if "requestTime" in data: _try_set(obj, "requestTime", int(data["requestTime"]))
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_RequestOptionInfo(body_dict)
