# modules/common/push/message0801_push.py
# auto-generated at 2025-08-24T20:13:14.034502+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0801 import *    # C# 모델(우선)
from nFusion.Model.CommonType import *     # 공통 타입(항상)
from System import String, UInt32, UInt64
from generator.message0801_generator import make_msg0801_body
...
def _dict_to_InitialPlanCommand(data: dict):
    obj = _new('InitialPlanCommand')
    ...
    if "operatorReplanRequestTime" in data: _try_set(obj, "operatorReplanRequestTime", int(data["operatorReplanRequestTime"]))
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_InitialPlanCommand(body_dict)
