# modules/common/push/message0101_push.py
# auto-generated at 2025-08-24T20:13:13.999836+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0101 import *    # C# 모델(우선)
from nFusion.Model.CommonType import *     # 공통 타입(항상)
from System import String, UInt32, UInt64
from generator.message0101_generator import make_msg0101_body
...
def _dict_to_SystemOperationMode(data: dict):
    obj = _new('SystemOperationMode')
    ...
    if "systemMode" in data: _try_set(obj, "systemMode", int(data["systemMode"]))
    return obj
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_SystemOperationMode(body_dict)
