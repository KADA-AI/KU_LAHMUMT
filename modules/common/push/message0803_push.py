# modules/common/push/message0803_push.py
# auto-generated at 2025-08-24T20:13:14.037501+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0803 import *    # C# 모델(우선)
...
def _dict_to_ExecutionCommand(data: dict):
    obj = _new('ExecutionCommand')
    ...
    if "execute" in data: _try_set(obj, "execute", int(data["execute"]))
    return obj
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_ExecutionCommand(body_dict)
