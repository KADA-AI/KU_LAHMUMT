# modules/common/push/message0204_push.py
# auto-generated at 2026-07-07T08:53:02.436445+00:00
...
from nFusion.Model.msg_0204 import *    # C# 모델(우선)
from nFusion.Model.CommonType import *     # 공통 타입(항상)
from System import String, UInt32, UInt64
from generator.message0204_generator import make_msg0204_body
...
TX_FIELD_WHITELIST = {
    ...
    "0204": ["timestamp", "inputMissionPackageID"],
...
def _dict_to_OutputMissionPlan(data: dict):
    obj = _new('OutputMissionPlan')
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_OutputMissionPlan(body_dict)
...
def make_and_push(body_dict: dict, node_messenger) -> bytes:
    ...
    log_line = (
        f"[0204] BODY  : {json.dumps(body_dict, ensure_ascii=False)}\n"
        f"[0204] PUSH 완료"
    )
