# modules/common/push/message0601_push.py
# auto-generated at 2025-08-24T20:13:14.027448+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0601 import *    # C# 모델(우선)
from nFusion.Model.CommonType import *     # 공통 타입(항상)
from System import String, UInt32, UInt64
from generator.message0601_generator import make_msg0601_body
...
def _dict_to_BasicAction(data: dict):
    obj = _new('BasicAction')
    ...
    _v = data.get("aircraftID", data.get("aircraft"))
    if _v is not None: _try_set(obj, "aircraftID", int(_v))
    if "flightMode" in data: _try_set(obj, "flightMode", int(data["flightMode"]))
    if "filmingMode" in data: _try_set(obj, "filmingMode", int(data["filmingMode"]))
    return obj
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_BasicAction(body_dict)
