# modules/common/push/message0702_push.py
# auto-generated at 2025-08-24T20:13:14.033501+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0702 import *    # C# 모델(우선)
from nFusion.Model.CommonType import *     # 공통 타입(항상)
from System import String, UInt32, UInt64
from generator.message0702_generator import make_msg0702_body
...
def _dict_to_PilotDecision(data: dict):
    obj = _new('PilotDecision')
    ...
    if "ignore" in data: _try_set(obj, "ignore", int(data["ignore"]))
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_PilotDecision(body_dict)
