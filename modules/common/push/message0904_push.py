# modules/common/push/message0904_push.py
# auto-generated at 2025-08-24T20:13:14.046863+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0904 import *    # C# 모델(우선)
from nFusion.Model.CommonType import *     # 공통 타입(항상)
from System import String, UInt32, UInt64
from generator.message0904_generator import make_msg0904_body
...
def _dict_to_RequestBehaviorTree(data: dict):
    obj = _new('RequestBehaviorTree')
    ...
    if "BehaviorTreeFileID" in data: _try_set(obj, "BehaviorTreeFileID", int(data["BehaviorTreeFileID"]))
    return obj
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_RequestBehaviorTree(body_dict)
