# modules/common/push/message0805_push.py
# auto-generated at 2025-08-24T20:13:14.038501+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0805 import *    # C# 모델(우선)
from nFusion.Model.CommonType import *     # 공통 타입(항상)
from System import String, UInt32, UInt64
from generator.message0805_generator import make_msg0805_body
...
def _dict_to_SystemEvent(data: dict):
    obj = _new('SystemEvent')
    ...
    if "eventType" in data: _try_set(obj, "eventType", int(data["eventType"]))
    return obj
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_SystemEvent(body_dict)
...
def make_and_push(body_dict: dict, node_messenger) -> bytes:
    ...
    log_line = (
        f"[0805] BODY  : {json.dumps(body_dict, ensure_ascii=False)}\n"
        f"[0805] PUSH 완료"
    )
