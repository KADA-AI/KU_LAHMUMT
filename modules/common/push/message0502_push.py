# modules/common/push/message0502_push.py
# auto-generated at 2025-08-24T20:13:14.024448+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0502 import *    # C# 모델(우선)
from nFusion.Model.CommonType import *     # 공통 타입(항상)
from System import String, UInt64
...
def _dict_to_EndMissionRequest(data: dict):
    obj = _new('EndMissionRequest')
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_EndMissionRequest(body_dict)
