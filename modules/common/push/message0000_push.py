# modules/common/push/message0000_push.py
# auto-generated at 2025-08-24T20:13:13.997327+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0000 import *    # C# 모델(우선)
...
def _dict_to_RequestData(data: dict):
    obj = _new('RequestData')
    ...
    if "messageID" in data: _try_set(obj, "messageID", int(data["messageID"]))
    return obj
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_RequestData(body_dict)
