# modules/common/push/message0503_push.py
# auto-generated at 2025-08-24T20:13:14.026448+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0503 import *    # C# 모델(우선)
...
def _dict_to_MissionResult(data: dict):
    obj = _new('MissionResult')
    ...
    if "systemRecommend" in data: _try_set(obj, "systemRecommend", int(data["systemRecommend"]))
    return obj
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_MissionResult(body_dict)
