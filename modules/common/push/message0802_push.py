# modules/common/push/message0802_push.py
# auto-generated at 2025-08-24T20:13:14.036501+00:00


import json, importlib
from datetime import datetime, timezone
from System.Collections.Generic import List
from nFusion.Model.msg_0802 import *    # C# 모델(우선)
...
def _dict_to_MandatoryCommand(data: dict):
    obj = _new('MandatoryCommand')
    ...
    if "mandatoryType" in data: _try_set(obj, "mandatoryType", int(data["mandatoryType"]))
    return obj
...
def _dict_to_obj(body_dict: dict):
    return _dict_to_MandatoryCommand(body_dict)
