...
class LAHOperationalEnvelope:
    ...
    # the hide point and the target.  Measured requirements on the operational
    # terrain ran 2250-2990 m, so a 2000 m mission ceiling suppressed every
    # tactical attack and left the manned aircraft holding with no attack point.
