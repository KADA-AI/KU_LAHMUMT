...
try:
    from ...data_def.id_allocator import reserve_mission_plan_ids
except Exception:
...
def _reserve_mission_plan_id() -> int:
    try:
...
def build_0301_from_0302_packages(
    ...
    *,
    ...
    plan_id = int(mission_plan_id) if mission_plan_id is not None else _reserve_mission_plan_id()
