...
_CANONICAL_NAME = "modules.mission_planning.engine.mission_generation.artifacts_0301_0302_0303_0304.d0301"
_ALIASES = (
...
_LEGACY_DATA_DEF_DIR = _PROJECT_ROOT / "modules" / "mission_planning" / "MissionPlanner" / "data_def"
_COUNTER_FILE = _LEGACY_DATA_DEF_DIR / "_id_counters.json"
_START_VALUE = {
...
def build_mission_plan(
    *,
    ...
    if mission_plan_id is None or (isinstance(mission_plan_id, str) and not mission_plan_id.strip()):
        mission_plan_id = int(reserve_mission_plan_ids(1)[0])
    else:
