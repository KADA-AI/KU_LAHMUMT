...
def detect_raster_path(resources_dir: str = "resources") -> str:
    ...
    if not tif_candidates:
        raise FileNotFoundError(
            f"No GeoTIFF (*.tif) files found under '{resources_dir}/'. "
...
def parse_args():
    ...
    parser.add_argument("--raster-path", type=str, default=None, help="Path to GeoTIFF elevation. Defaults to first file under resources/.")
