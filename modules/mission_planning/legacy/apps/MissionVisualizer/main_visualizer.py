...
Usage:
    python -m modules.mission_planning.apps.MissionVisualizer.main_visualizer
"""
...
from modules.mission_planning.legacy.ui.id_relationship_tab import RelationshipCache
...
class MissionPlanVisualizer(QWidget):
    ...
    def _resolve_default_dir(self) -> Path:
        ...
        scenario_file = existing_scenario_info_path()
        try:
