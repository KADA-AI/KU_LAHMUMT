...
from modules.common.turn_dynamics import REFERENCE_TURN_RADIUS_TABLE_MPS
try:
...
TURN_RADIUS_BY_SPEED_MPS: Dict[float, float] = dict(REFERENCE_TURN_RADIUS_TABLE_MPS)
