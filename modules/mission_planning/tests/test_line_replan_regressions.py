...
class LineReplanRegressionTests(unittest.TestCase):
    ...
    def test_initial_line_uses_regular_entry_without_close_takeover_special_case(self) -> None:
        ...
        self.assertGreater(
            d0303_artifacts._dist_between_coords(waypoints[0]["coordinate"], line_start),
            400.0,
        )
        self.assertTrue(
            any(
    ...
    def test_post_attack_completion_hold_is_fixed_to_fifteen_seconds(self) -> None:
        ...
        self.assertEqual(hold_seconds, 15)
        self.assertEqual(waypoint["waypointPassType"], 2)
        self.assertEqual(waypoint["loiterProperty"]["time"], 15)
