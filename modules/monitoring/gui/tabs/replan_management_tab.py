...
class ReplanManagementTab(QWidget):
    ...
    def _parameter_sections(self) -> list[tuple[str, str, list[FieldSpec]]]:
        return [
            ...
            (
                "촬영계획 / 다음협업 / 연료",
                "촬영 일정 기반 재계획, 다음 협업 진입, 연료 경계값을 한곳에서 조정합니다.",
                [
                    ...
                    FieldSpec("next_collab", "entry_lead_time_s", "다음 임무 진입 선행시간 (s)", "float", 0.0, 60.0, 0.5, 1),
                    FieldSpec(
                        "next_collab",
                        "default_entry_strategy",
                        "기본 진입 전략",
                        "choice",
                        options=(("중간점 진입", "midpoint_to_next_start"), ("선회 예측 진입", "turn_projection")),
                    ),
