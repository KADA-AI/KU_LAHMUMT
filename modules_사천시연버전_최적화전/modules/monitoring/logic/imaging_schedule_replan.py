        ...
        *,
        ...
        for mission in mission_list:
            ...
            for waypoint in waypoint_list:
                ...
                if int(waypoint_id) == int(current_waypoint_id):
                    current_waypoint = dict(waypoint)
            if int(current_waypoint_id) not in waypoint_ids or not isinstance(current_waypoint, dict):
                continue
