...
def run_enhanced_divide_and_pattern(
    ...
    if int(option_code or 0) == 4 and review_enabled:
        ...
        if summarize_recon_area_review_guard is not None:
            guard = summarize_recon_area_review_guard(
                review_report=recon_review,
    ...
    if int(option_code or 0) == 4 and summarize_recon_expected_path_quality is not None:
