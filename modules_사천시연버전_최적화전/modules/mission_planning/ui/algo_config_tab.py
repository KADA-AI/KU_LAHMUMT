...
GENERAL_GROUPS: list[tuple[str, str, list[FieldSpec]]] = [
    ...
    (
        ...
        [
            ...
            FieldSpec("values", "area_fov_db_smaller_fov_steps", "Area DB FOV lower steps", "int", 0, 20, 1),
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            FieldSpec("values", "fov_db_smaller_fov_steps", "DB FOV 낮춤 단계", "int", 0, 20, 1),
...
class MissionAlgoConfigTab(QWidget):
    ...
    def _normalize_payload(self, payload: Dict[str, Any] | None) -> Dict[str, Any]:
        ...
        values["fov_db_smaller_fov_steps"] = max(
            0,
            min(20, int(self._as_float(values.get("fov_db_smaller_fov_steps"), 3))),
        )
        values["area_fov_db_smaller_fov_steps"] = max(
            0,
            min(20, int(self._as_float(values.get("area_fov_db_smaller_fov_steps"), 1))),
        )
