# modules/common/generator/message0904_generator.py
# auto-generated at 2025-08-24T14:56:18.174150+00:00
...
def _gen_RequestBehaviorTree(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["source"] = gen_value("source", "string", MSG_ID, obj, 0)
    obj["BehaviorTreeFileID"] = gen_value("BehaviorTreeFileID", "uint32", MSG_ID, obj, 0)
    return obj




def make_msg0904_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0904, RootType: RequestBehaviorTree"""
    ex = _gen_RequestBehaviorTree(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0904_push import make_and_push
