...
class ModuleWithLog(Card):
    ...
    구성:
      ...
      3) 중간: "from app.core.adapters.nfusion.receive_center import notify" / "송신 목록" 라벨 + 2열 표(코드, 카운트) — 내부 스크롤
    ...
    def __init__(self, title: str, parent=None):
        ...
        lbl_rx = QLabel("from app.core.adapters.nfusion.receive_center import notify", self)
    ...
    def bump_rx(self, code: str):
        """from app.core.adapters.nfusion.receive_center import notify에서 해당 코드의 카운트를 +1"""
    ...
    def set_rx_rows(self, rows):
        """from app.core.adapters.nfusion.receive_center import notify 전체 교체: rows=[(code, count), ...]"""
