...
# MissionMonitoringReplanCSCTab 직접 사용 대신 MissionMonitoringTab 사용
# from mission_monitoring_replan.mission_monitoring_replan_csc_tab import MissionMonitoringReplanCSCTab
