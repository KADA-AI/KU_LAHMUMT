# modules/common/generator/message0103_generator.py
# auto-generated at 2025-08-24T14:56:18.123615+00:00
...
def _gen_SWStatus(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["source"] = gen_value("source", "string", MSG_ID, obj, 0)
    obj["status"] = gen_value("status", "uint32", MSG_ID, obj, 0)
    obj["mode"] = gen_value("mode", "uint32", MSG_ID, obj, 0)
    return obj




def make_msg0103_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0103, RootType: SWStatus"""
    ex = _gen_SWStatus(source=source)
