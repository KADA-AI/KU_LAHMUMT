# modules/common/generator/message0803_generator.py
# auto-generated at 2025-08-24T14:56:18.163148+00:00
...
def _gen_ExecutionCommand(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["source"] = gen_value("source", "string", MSG_ID, obj, 0)
    obj["execute"] = gen_value("execute", "uint32", MSG_ID, obj, 0)
    return obj




def make_msg0803_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0803, RootType: ExecutionCommand"""
    ex = _gen_ExecutionCommand(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0803_push import make_and_push
    return make_and_push(make_msg0803_body(), node_messenger)

if __name__ == "__main__":
    print(json.dumps(make_msg0803_body(), ensure_ascii=False, indent=2))