# modules/common/generator/message0301_generator.py
# auto-generated at 2025-08-24T14:56:18.132116+00:00
...
def _gen_Aircraft(source: str = "DS"):
    obj = {}
...
def _gen_MissionPlanData(source: str = "DS"):
    obj = {}
    obj["timestamp"] = gen_value("timestamp", "uint64", MSG_ID, obj, 0)
    obj["missionPlanID"] = gen_value("missionPlanID", "uint32", MSG_ID, obj, 0)
    obj["missionPlanTimestamp"] = gen_value("missionPlanTimestamp", "uint64", MSG_ID, obj, 0)
    obj["planningTime"] = gen_value("planningTime", "float32", MSG_ID, obj, 0)
    obj["plannerID"] = gen_value("plannerID", "uint32", MSG_ID, obj, 0)
    ...
    obj["aircraftList"] = [ _gen_Aircraft(source=source) for _ in range(LIST_LEN) ]
    return obj




def make_msg0301_body(source: str = "DS"):
    """자동 생성된 메시지 바디 — MessageID: 0301, RootType: MissionPlanData"""
    ex = _gen_MissionPlanData(source=source)
...
def make_random_and_push(node_messenger):
    from generator.message0301_push import make_and_push
